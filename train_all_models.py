#!/usr/bin/env python3
"""
Train all models (Transformer, LSTM, Mamba, xLSTM, Linear) and compare results
"""
...
MODELS = [
    ("transformer", "configs/all_models_transformer.yaml"),
    ("lstm", "configs/all_models_lstm.yaml"),
...
def main():
    ...
    with open("all_models_results.txt", "w") as f:
        f.write("=" * 70 + "\n")
        f.write("ALL MODELS TRAINING RESULTS\n")
        f.write("=" * 70 + "\n\n")
    ...
    print("\nResults saved to: all_models_results.txt")
